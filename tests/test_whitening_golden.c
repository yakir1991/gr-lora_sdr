...
int main(void) {
  ...
  lora_generate_whitening_seq(seq);

  static const uint8_t golden_seq[LORA_WHITENING_SEQ_LEN] = {
  ...
  if (memcmp(seq, golden_seq, LORA_WHITENING_SEQ_LEN) != 0) {
    LORA_LOG_INFO("Whitening sequence generation failed");
    return 1;
  }
  ...
  static const uint8_t golden[32] = {160, 204, 21,  204, 243, 103, 239, 45,
